...
2. 点击脚本管理器的「添加新脚本」，将本仓库中 `[[deepseek-usage-injector.user.js](https://github.com/Jmkwang/DeepSeek-Usage-Enhancer/blob/main/DeepSeek%20Usage%20Enhancer.js)](https://github.com/Jmkwang/DeepSeek-Usage-Enhancer/blob/main/DeepSeek-Usage-Enhancer.js)` 的**全部内容**粘贴进去，保存。
